...
const Dashboard: React.FC = () => {
    ...
    const handleAccept = async (match: {
        ...
        AWS.config.credentials = new AWS.CognitoIdentityCredentials({
            IdentityPoolId:
                "ap-southeast-1:d9dff0e5-1df8-40d0-998c-b407cededc73",
        });
            ...
            <main className="max-w-7xl mx-auto">
                <div className="relative bg-gradient-to-r from-green-400 via-green-500 to-green-600 text-white p-8 rounded-lg shadow-lg">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-lg">
                            We're glad to have you here. Explore our features
                            ...
                            <div className="flex flex-col items-center w-full">
                                ...
                                <div className="flex flex-col items-center justify-center text-center">
                                    ...
                                    <p className="text-lg text-gray-700 mb-4">
                                        Cumulative requests by beneficiaries
                ...
                <section className="bg-[#F0F4E4] p-12 rounded-lg shadow-lg">
                    ...
                    <p className="text-lg text-gray-700 mb-8 text-center">
                        The matching recommendations are based on several
                        factors including distance, availability of stock, and
                        other relevant parameters. The top recommendations are
                        displayed at the top of the list to help you easily find
                        the best matches.
                    </p>
