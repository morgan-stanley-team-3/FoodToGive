...
const Header: React.FC = () => {
  ...
  return (
    <header className="flex justify-between items-center mb-12 bg-white shadow-md p-4">
      <div className="text-3xl font-bold text-green-600">FoodToGive - Singapore Food Bank </div>
      <nav className="space-x-6 text-lg">
        ...
        <a href="/login" className="text-gray-700 hover:text-[#A2C765]">Login</a>
        <a href="/signup" className="text-gray-700 hover:text-[#A2C765]">Signup</a>
