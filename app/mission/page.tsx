    ...
    <div className="bg-gray-50 min-h-screen p-8">
      ...
      <main className="max-w-7xl mx-auto">
        <section className="bg-white rounded-lg shadow-lg p-12 mb-12">
          <h1 className="text-4xl font-bold text-center mb-8 text-[#A2C765]">Our Mission</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 bg-[#F0F4E4] rounded-lg">
              <h2 className="text-2xl font-semibold mb-4 text-[#A2C765]">Empowering Communities</h2>
            ...
            <div className="p-6 bg-[#F0F4E4] rounded-lg">
              <h2 className="text-2xl font-semibold mb-4 text-[#A2C765]">Innovative Solutions</h2>
              <p className="text-gray-700">
        ...
        <section className="bg-[#E7EDCF] p-12 rounded-lg shadow-lg">
          <h2 className="text-3xl font-bold text-center text-[#A2C765] mb-8">Join Our Mission</h2>
